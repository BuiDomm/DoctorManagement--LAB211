...
public class ManageDoctor {
    ...
    HashMap<String, Doctor> hashDoctorList = new HashMap<>();
...
//        System.out.println(d.getCode() + "       " + d.getName() + "      " + d.getSpecialization() + "                " + d.getAvai());
    ...
    public HashMap<String, Doctor> search(Predicate<Doctor> d) {
    ...
    public void displayAll(HashMap<String, Doctor> list) {
        ...
        for (Map.Entry<String, Doctor> entry : list.entrySet()) {
            System.out.printf("%-5s|%-7s|%-15s|%-5d\n", entry.getKey(), entry.getValue().getName(), entry.getValue().getSpecialization(), entry.getValue().getAvai());
